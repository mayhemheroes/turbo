...
var file_turborepo_ffi_messages_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x24, 0x0a, 0x0e, 0x50, 0x61, 0x63,
...
var file_turborepo_ffi_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_turborepo_ffi_messages_proto_goTypes = []interface{}{
	...
	nil,                                              // 35: WorkspaceDependencies.DependenciesEntry
	nil,                                              // 36: TransitiveDepsRequest.WorkspacesEntry
	nil,                                              // 37: AdditionalBerryData.ResolutionsEntry
	nil,                                              // 38: FileHashes.HashesEntry
	nil,                                              // 39: EnvVarMap.MapEntry
}
var file_turborepo_ffi_messages_proto_depIdxs = []int32{
	...
	35, // 3: WorkspaceDependencies.dependencies:type_name -> WorkspaceDependencies.DependenciesEntry
	0,  // 4: TransitiveDepsRequest.package_manager:type_name -> PackageManager
	36, // 5: TransitiveDepsRequest.workspaces:type_name -> TransitiveDepsRequest.WorkspacesEntry
	...
	37, // 8: AdditionalBerryData.resolutions:type_name -> AdditionalBerryData.ResolutionsEntry
	...
	38, // 15: FileHashes.hashes:type_name -> FileHashes.HashesEntry
	...
	39, // 19: EnvVarMap.map:type_name -> EnvVarMap.MapEntry
	17, // 20: WorkspaceDependencies.DependenciesEntry.value:type_name -> LockfilePackageList
	11, // 21: TransitiveDepsRequest.WorkspacesEntry.value:type_name -> PackageDependencyList
